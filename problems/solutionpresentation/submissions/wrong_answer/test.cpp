...
long long goal = 1711976400; // Unix Time for 2024-04-01 13:00:00
...
int main() {
    ...
    april_first_tm.tm_mon = 3;  // April (zero-based)
    ...
    // Output the result
    std::cout << "Seconds until April 1st, 12:00:00: " << seconds << std::endl;
    return 0;
}
